...
const Hero = () => {
  return (
    ...
    >
      ...
      {/* Content */}
      <p className="text-white absolute bottom-7 md:bottom-14 left-10 md:left-20 z-20 font-cabinetGroteskRegular font-semibold tracking-wider text-4xl md:text-6xl">
        Welcome to <br /> <span>Qitchen</span>
      </p>
      {/* Socials */}
